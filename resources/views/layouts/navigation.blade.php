        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('index')" :active="request()->routeIs('/')"> <!-- Elegis la ruta a redireccionar -->
                        {{ __('Inicio') }} <!-- Cambia el nombre del link -->
                    </x-nav-link>
                    <x-nav-link :href="route('category')" :active="request()->routeIs('category')"> <!-- Elegis la ruta a redireccionar -->
                        {{ __('Categorías') }} <!-- Cambia el nombre del link -->
                    </x-nav-link>
                    @if (Auth::check())
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                ...
                                <div>{{ Auth::user()->username }}</div> <!-- el nombre con el dropdwon -->

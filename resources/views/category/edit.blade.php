                            ...
                            <div class="max-w-xl">
                                <form action="/category/edit/{{$post->id}}" method="POST">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" id="title" name="title" class="mt-1 p-1 w-full bg-white dark:bg-gray-900 text-white border rounded" value="{{$post->title}}" />
                                    </div>
                                    <div class="mb-5">
                                        <label for="poster" class="text-white">Poster:</label>
                                        <input type="file" id="poster" name="poster" accept="image/*" class="mt-1 p-1 w-full bg-white dark:bg-gray-900 text-white border rounded" value="{{$post->poster}}" />
                                    </div>
                                    <div class="mb-5">
                                        <label for="content" class="text-white">Contenido:</label>
                                        <input type="text" id="content" name="content" class="mt-1 p-1 w-full bg-white dark:bg-gray-900 text-white border rounded" value="{{$post->content}}" />
                                    </div>
                                    <div class="mb-5">
